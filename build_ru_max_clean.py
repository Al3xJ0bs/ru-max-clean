...
# Cyrillic + Latin + Greek. Scientific/technical tokens such as pH, USB, H2O and
# Greek-letter terms are deliberately allowed; purely numeric keys are rejected.
LETTER_RE = re.compile(r"[A-Za-z\u0370-\u03ff\u0400-\u052f]")
